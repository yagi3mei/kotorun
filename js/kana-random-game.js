// =========================================
//      File: kana-random-game.js
//      Purpose: かなゲームランダムのゲーム画面
//      Author: やぎさん
//      Created: 2026-08-19
// 
//      Notes:
//      - かなゲームランダムの共通JavaScriptファイル
//      - kana-random-subindex.htmlからゲームタイプをURLパラメータで受け取って、ゲームの内容を切り替える
...
const RANDOM_QUESTIONS =
    QUESTIONS.filter(q => q.kana_char !== "");
...
function getStorageKey(type) {
    ...
    const map = {
        "seion": "random_hiragana_seion",
        "dakuon": "random_hiragana_dakuon",
        "youon": "random_hiragana_youon",

        "katakana-seion": "random_katakana_seion",
        "katakana-dakuon": "random_katakana_dakuon",
        "katakana-youon": "random_katakana_youon",
        "katakana-extra": "random_katakana_extra"
    };
...
function goMenu() {
    location.href = "kana-random-subindex.html";
}
